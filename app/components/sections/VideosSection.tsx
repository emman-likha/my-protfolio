/**
 * VIDEOS SECTION COMPONENT (app/components/sections/VideosSection.tsx)
 * Displays video projects with "SEE MORE" button
 */
...
export default function VideosSection({ projects, onProjectClick }: VideosSectionProps) {
  ...
  return (
    <div className="w-full max-w-7xl relative h-full pt-20 md:pt-32 px-4 md:px-0">
      ...
      <div className="fixed top-20 md:top-32 left-4 md:left-20 h-[8rem] md:h-[10rem] flex items-center justify-start z-30 scale-75 md:scale-100 origin-left">
         <TextHoverEffect text="| VIDEOGRAPHY" />
      </div>
      {/* Projects Grid - Shows first 2 video projects */}
      ...
      <motion.button
        onClick={() => router.push('/projects/videos')}
        whileHover={{ x: -10 }}
